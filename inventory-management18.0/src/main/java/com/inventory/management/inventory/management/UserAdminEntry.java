 ...
 * @author gaura
 */
public class UserAdminEntry extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(10, 240, 590, 130);
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 150, 610, 390));
...
new UserMenu().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserAdminEntry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
