 ...
 * @author gaura
 */
public class UserPart_entry1 extends javax.swing.JFrame {

    /**
     * Creates new form AdminEntry
     */
    public UserPart_entry1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 150, 610, 490));
...
new UserMenu1().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserPart_entry1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserPart_entry1().setVisible(true);
            }
        });
    }
